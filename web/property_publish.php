  	...
  	<body>					
		...
		<div class="container">
			...
			<div class="col-lg-12 well">
				<div class="row">
					<form name="form" method="post" action="property_publish_check.php" onsubmit="return publish_validation()" enctype="multipart/form-data">
						<div class="col-sm-12">
							<div class="row">					
							...
							<div class="row">
								...
								<div class="col-sm-3 form-group">
									<label>Numero</label>
									<input name="numero" maxlength="11" id="numero" onkeypress="return justNumbers(event);" type="text" placeholder="Ingresa el numero aqui.." class="form-control">
								</div>	
								<div class="col-sm-3 form-group">
									<label>Piso</label>
