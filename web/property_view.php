...
<html lang="en">
  	...
  	<body>
    	<?php
	    	...
	    	$query = mysql_query("SELECT id_propiedad FROM foto WHERE id_foto = '$_POST[id_foto]'");
	    	$result = mysql_fetch_array($query);
			$result1 = mysql_query("SELECT * FROM foto WHERE id_foto = '$_POST[id_foto]'");
			$foto_propiedad = mysql_fetch_array($result1);
			$result2 = mysql_query("SELECT * FROM propiedad WHERE id_propiedad = '$result[id_propiedad]'");
